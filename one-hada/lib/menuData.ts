export const buttons = [
  { label: '조회', targetId: 'inquiry' },
  { label: '이체', targetId: 'transfer' },
  { label: '자산관리', targetId: 'assetManagement' },
  { label: '예적금', targetId: 'savings' },
  { label: '퇴직연금', targetId: 'irp' },
  { label: '펀드', targetId: 'fund' },
  { label: '신탁', targetId: 'trust' },
  { label: 'ISA', targetId: 'isa' },
  { label: '대출', targetId: 'loan' },
  { label: '외환', targetId: 'foreign' },
  { label: '보험', targetId: 'insurance' },
  { label: '공과금', targetId: 'bill' },
  { label: '번호표/출금/결제', targetId: 'mobileTicket' },
  { label: '카드', targetId: 'card' },
  { label: '하나금융그룹', targetId: 'group' },
  { label: '사업자/시니어/VIP/YOUNG', targetId: 'customer' },
  { label: '이벤트/스포츠', targetId: 'event' },
  { label: '생활', targetId: 'life' },
];
